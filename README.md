...
Detailed information about this specific `sprwf-cheminfo` workflow is available 
[here](https://systempipe.org/sprwf-cheminfo/SPcheminfo.html).
...
genWorkenvir_gh(url = "https://github.com/systemPipeR/sprwf-cheminfo.git", mydirname = "sprwf-cheminfo")
setwd("sprwf-cheminfo")
getParam_gh()
